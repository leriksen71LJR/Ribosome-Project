...
**Tension refs:** [0006](../../tensions/0006-incomplete-contract-acceptance.md)
...
**Acceptance criteria (`../../tensions/0006-incomplete-contract-acceptance.md`):**
...
- **Applier:** `IEncryptionService.ApplyKeyAsync` on interface — not a static helper (tension [0006](../../tensions/0006-incomplete-contract-acceptance.md)).
...
Related: `Infrastructure plugin`, `../../tensions/0006-incomplete-contract-acceptance.md`.
