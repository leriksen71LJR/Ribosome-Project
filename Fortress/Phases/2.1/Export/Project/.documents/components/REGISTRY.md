...
Era B cluster register: `Fortress/Archive/_Supporting/BuildDisclosure/Build-Agent-Disclosure-Responses-2026-06-21.md` Appendix D.3 (historical — not on agent read path).