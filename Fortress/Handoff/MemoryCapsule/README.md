...
2. **`Fortress/Handoff/MemoryCapsule/CURRENT.md`** — executive state (this system)
...
|------|------------------|-------|
| **Super Grok** | `Fortress/Handoff/MemoryCapsule/` | Doc fixes, export, steward analysis, `handoff-audit.md` |
| **Lead Researcher** | Research agent's capsule (user-provided) | Composite synthesis, Phase 2 arc, `Research/` |
