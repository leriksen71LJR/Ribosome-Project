...
- **This chat's role:** Research & Philosophy layer only
  ...
  - Produce analysis and recommendations into `Research/Records/Export/`
...
3. **Strengthen the Research layer** — Keep `Research/` clean, focused, and high-signal (major folder cleanup completed 2026-06-25; `Phases/` restructured with per-phase subfolders like 2.1/, 2.2/ 2026-06-26). Session 002 active.
...
- Established `Research/Records/Export/` as the official handoff location for analysis reports
...
- Producing clean, forwardable artifacts into `Research/Records/Export/`
...
- Write analysis/reports into `Research/Records/Export/` using clear, dated names
