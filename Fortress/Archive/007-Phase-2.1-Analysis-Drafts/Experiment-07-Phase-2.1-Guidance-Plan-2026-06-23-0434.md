...
- Agents should act as **structured gap detectors**. When they encounter a seam with insufficient guidance or must invent behavior not covered by an existing strategy, they should explicitly flag this in the build report.
