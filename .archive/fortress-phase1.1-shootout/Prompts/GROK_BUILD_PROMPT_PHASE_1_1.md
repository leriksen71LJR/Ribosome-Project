...
The `.docs/` folder + root `AGENTS.md` and `README.md` are the ONLY authoritative source. Read and follow them strictly.
...
I understand I must produce a structured build report in `.docs/Builds/` named `BUILD-YYYY-MM-DD-GrokBuild.md` and explicitly document any deviations from the rules.
...
- Write a structured report named `BUILD-YYYY-MM-DD-GrokBuild.md` following the requirements in `PHASE_1_1_IMPROVEMENTS.md`.
- Explicitly list any deviations from documented rules under a "Deviations from Documentation" section.

**Goal:** Build a complete, working Fortress console application that follows the documentation as closely as possible.