...
- Save a structured build report named `BUILD-YYYY-MM-DD-Claude.md`.
- Organize the report into logical grouped sections.
- Include a clear **"Deviations from Documentation"** section with explanations.
- See `.docs/Phases/PHASE_1_1_IMPROVEMENTS.md` for full requirements and examples.
